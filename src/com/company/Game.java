...
public class Game {
    ...
    public void setupGameMap() {
        map = new GameMap();
        //setup map
        Location hospital = new Location("hospital","There is a building that seems to be hospital.");
        ...
        //intro psycho, hunter etc add edges? to not set as an option -> change map and set these nodes and distance = 0?
        ...
        //what if hunting fails? what happens
